...
import 'package:revise_section_one/widgets/chart/chart_bar.dart';
...
//list of  model bucket expnses as type of getter
  List<ExpenseBucket> get buckets {
    //return list of category
    return [
      ExpenseBucket.forCategory(expenses, Category.food),
      ExpenseBucket.forCategory(expenses, Category.leisure),
      ExpenseBucket.forCategory(expenses, Category.trave),
